...
const std::unordered_map<std::string, SampleRenderV2::GraphicsAPI> SampleRenderV2::ApplicationStarter::s_GraphicsAPIMapper =
{
	...
	{"SAMPLE_RENDER_GRAPHICS_API_VULKAN", SampleRenderV2::GraphicsAPI::SAMPLE_RENDER_GRAPHICS_API_VK},
#ifdef RENDER_USES_WINDOWS
	{"SAMPLE_RENDER_GRAPHICS_API_DX12", SampleRenderV2::GraphicsAPI::SAMPLE_RENDER_GRAPHICS_API_D3D12},
	{"SAMPLE_RENDER_GRAPHICS_API_D3D12", SampleRenderV2::GraphicsAPI::SAMPLE_RENDER_GRAPHICS_API_D3D12},
	{"SAMPLE_RENDER_GRAPHICS_API_DIRECTX12", SampleRenderV2::GraphicsAPI::SAMPLE_RENDER_GRAPHICS_API_D3D12},
	{"SAMPLE_RENDER_GRAPHICS_API_DIRECT3D12", SampleRenderV2::GraphicsAPI::SAMPLE_RENDER_GRAPHICS_API_D3D12},
#endif
};
